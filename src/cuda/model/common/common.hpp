...
#define TRT_MODEL_API __declspec(dllexport)
...
// inline static int read_files_in_dir(const char *p_dir_name, std::vector<std::string> &file_names)
// {
...
// inline static cv::Mat preprocessImg(cv::Mat &img, int input_w, int input_h, int &X_LEFT_PAD, int &X_RIGHT_PAD,
//                                     int &Y_TOP_PAD, int &Y_BOTTOM_PAD)
// {
//     int   w, h;
//     float x, y;
