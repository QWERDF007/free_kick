...
LogStream<kSeverity> &operator<<(LogStream<kSeverity> &stream, const T &msg)
{
...
[[noreturn]] void throwCudaError(const char *file, const char *function, int line, int status,
                                 const char *msg = nullptr);
[[noreturn]] void throwCudnnError(const char *file, const char *function, int line, int status,
                                  const char *msg = nullptr);
[[noreturn]] void throwCublasError(const char *file, const char *function, int line, int status,
                                   const char *msg = nullptr);
[[noreturn]] void throwPluginError(const char *file, const char *function, int line, int status,
                                   const char *msg = nullptr);
...
{
public:
    PluginError(const char *fl, const char *fn, int ln, int stat, const char *msg = nullptr)
